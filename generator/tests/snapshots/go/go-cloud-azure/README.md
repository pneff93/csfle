# 🔐 my-cloud-azure-go-client

Cloud/Azure Go demo client used in snapshot tests.
...
1. Creates the Kafka topic `my-cloud-azure-go-client-0038` (idempotent — safe to re-run).
2. Registers the schema for `my-cloud-azure-go-client-0038-value` with the `birthday` field tagged as `PII`.
