...
import (
	...
	"my-cloud-hashicorp-go-client/internal/config"
	"my-cloud-hashicorp-go-client/internal/model"
)
...
func main() {
	...
	srConfig.BasicAuthUserInfo = os.Getenv("SCHEMA_REGISTRY_BASIC_AUTH_USER_INFO")
	...
	ruleConfig, err := config.GetHcVaultRuleConfig()
	if err != nil {
