# 🔐 my-cloud-aws-dotnet-client

Cloud/AWS .NET demo client used in snapshot tests.
...
1. Creates the Kafka topic `my-cloud-aws-dotnet-client-0029` (idempotent — safe to re-run).
2. Registers the schema for `my-cloud-aws-dotnet-client-0029-value` with the `birthday` field tagged as `PII`.
