import com.cspeExample.PersonalData
    ...
    fun produceEvents(properties: ProducerProperties, data: List<String>): Thread {
        ...
        val thread = Thread {
            ...
            data.forEach { event ->
                ...
                try {
                    kafkaProducer.send(ProducerRecord("pneff-cspe-test", personalData.getId(), personalData),
                    ...
                    logger.error("${e.printStackTrace()} for $personalData")
                }
