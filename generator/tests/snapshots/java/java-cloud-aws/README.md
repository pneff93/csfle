# 🔐 my-cloud-aws-java-client

Cloud/AWS Java demo client used in snapshot tests.
...
1. Compiles the project (if needed) and runs `BootstrapTopic` to create the Kafka topic `my-cloud-aws-java-client-0013` (idempotent).
2. Registers the schema for `my-cloud-aws-java-client-0013-value` with the `birthday` field tagged as `PII`.
