# 🔐 my-cloud-aws-js-client

Cloud/AWS JavaScript demo client used in snapshot tests.
...
1. Creates the Kafka topic `my-cloud-aws-js-client-0021` (idempotent — safe to re-run).
2. Registers the schema for `my-cloud-aws-js-client-0021-value` with the `birthday` field tagged as `PII`.
