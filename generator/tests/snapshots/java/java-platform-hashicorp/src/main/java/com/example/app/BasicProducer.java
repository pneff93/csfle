...
public class BasicProducer {
    ...
    private static Properties getProperties() {
        ...
        props.setProperty(ProducerConfig.CLIENT_ID_CONFIG, "my-platform-hashicorp-java-client-producer");
