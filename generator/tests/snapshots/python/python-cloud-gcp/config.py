...
def validate_config():
    ...
    _get_env('GCP_KMS_KEY_NAME')
    _get_env('GCP_KMS_TYPE')
    _get_env('GCP_KMS_KEY_ID')
    _get_env('GCP_CLIENT_ID')
    _get_env('GCP_CLIENT_EMAIL')
    _get_env('GCP_PRIVATE_KEY_ID')
    _get_env('GCP_PRIVATE_KEY')
